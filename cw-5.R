...
inc <- read.csv("/Users/saiteja/Downloads/Income.csv")
...
churn <- read.csv("/Users/saiteja/Downloads/churn.csv")
...
stats <- read.csv("/Users/saiteja/Downloads/Demographics.csv")
...
# Different colors
ggplot(stats, aes(x = Income.Group, y = Birth.rate, color = "red")) +
  geom_point()
